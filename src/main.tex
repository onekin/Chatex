...
\newcommand{\context}[1]{#1\listgadd\contextlist{#1}% Add the variable to a list
}
...
\newcommand{\shortChatex}[3][red]{
 \setulcolor{#1}
 \href{https://chat.openai.com/chat?q=#2}{\ul{#3}}
}

\newcommand{\chatexC}[2][red]{
 \setulcolor{#1}
...
\newcommand{\shortChatexC}[3][red]{
 ...
 \ifboolexpr{test {\ifdefempty{\contextlist}}}{%
   \href{https://chat.openai.com/chat?q=#2}{\ul{#3}}
    ...
    %\forlistloop{\textcolor{red}}\contextlist% Print each value in red%
    \concatlist{\myvar}{\contextlist}
    \href{https://chat.openai.com/chat?q=#2\&c=\myvar}{\ul{#3}}
    %\renewcommand{\contextlist}{}% Clear the context list
    \ignorespaces
  }
}
